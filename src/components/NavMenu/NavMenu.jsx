...
import "./NavMenu.css";
import logo from "../../media/Rectangle10.png"
    ...
    <nav id="navMenu">
      <div id="menu">
        <div id="user-container">
          <img id="image-user" src={logo} alt="img-profile" />
        ...
        <div id="anchor-container">
          <a className="anchor-menu" href="">Home</a>
          <a className="anchor-menu" href="">Mangas</a>
          <a className="anchor-menu" href="">My Mangas</a>
          <a className="anchor-menu" href="">Favourites</a>
          <a className="anchor-menu" href="">Logout</a>
        </div>
      </div>
    </nav>
  );
